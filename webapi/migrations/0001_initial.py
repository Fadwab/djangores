    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('heure_deb', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            name='Salle',
            fields=[
                ('salle_id', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.AddField(
            ...
            name='salle',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='webapi.Salle'),
        ),
        migrations.AddField(
            model_name='reservation',
            name='user',
